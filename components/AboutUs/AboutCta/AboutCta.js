  ...
  return (
    <div className="about-cta">
      <div className="about-cta-container">
        ...
        <p className="text paragraph">Schedule a meeting with us.</p>
        <p className="text paragraph">
          We will advise you with the most optimal technologies to solve your
          need and we
        </p>
        <p className="text paragraph">will give you a personalized quote for free.</p>
      ...
      {!mobile && <img className="about-cta-img" src="./illustrations/about-us.svg" alt="" />}
    </div>
  );
}
